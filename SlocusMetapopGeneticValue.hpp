...
//
#ifndef FWDPY11_SLOCUSMETAPOP_GENETIC_VALUE_HPP__
#define FWDPY11_SLOCUSMETAPOP_GENETIC_VALUE_HPP__
...
namespace fwdpy11
{
    struct SlocusMetapopGeneticValue
    /// API class
    ...
    /// Any deme/geography-specific details must be handled by the derived class.
    {
	    ...
	    const std::vector<std::size_t>& /*N_psum*/) const = 0;
